        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className={`text-white fade-in ${inView ? "visible" : ""}`}>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Shriram Park 63 Perungalathur: Luxury 2, 3 & 4 BHK Flats on GST Road
            </h1>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3">
                ...
                <p className="text-lg">57-Acre Premium Township</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-accent rounded-full"></div>
                <p className="text-lg">Overlooking 1350-Acre Vandalur Forest Reserve</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-accent rounded-full"></div>
                <p className="text-lg">40+ State-of-the-Art Amenities</p>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-accent rounded-full"></div>
                <p className="text-lg">Fully Furnished Move-in Ready Homes Available</p>
              </div>
            </div>
          ...
          <div className={`fade-in ${inView ? "visible" : ""}`}>
            <div id="lead-form-hero" className="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
              ...
              <form onSubmit={handleFormSubmit} className="space-y-4">
                <div>
                  <Input
                    ...
                    className="w-full border-2 border-gray-300 focus:border-accent py-6 text-lg"
                    required
                  />
                </div>
                ...
                <Button 
                  type="submit" 
                  className="w-full btn-hero-primary text-xl py-7"
                >
